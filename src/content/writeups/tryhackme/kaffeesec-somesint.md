...
difficulty: 'medium'
date: 2025-08-29
summary: 'An OSINT investigation that starts from a single social media profile and spirals outward through Twitter bios, Reddit post histories, reverse image searches, follower analysis, Wayback Machine snapshots, and cached Pastebin links — ultimately uncovering a target hidden identity, coworker connections, and personal secrets buried across the open web.'
role: 'soc'
tags: ['osint', 'social-media', 'twitter', 'reddit', 'wayback-machine', 'reverse-image-search', 'pastebin', 'social-engineering', 'reconnaissance']
problem: 'Given a target individual named Thomas with a public social media presence, the task is to map his digital footprint entirely through open-source intelligence — extracting personal details from bios and posts, identifying connected individuals through follower analysis, pivoting across platforms via shared usernames, recovering deleted content through web archives, and following a chain of cached links and passwords to uncover information he tried to keep hidden.'
action: 'Started with Thomas social media profiles and extracted biographical details including his favourite holiday and birth date from public posts. Identified his fiancee through Twitter follower analysis and pivoted to her account to gather relationship details, vacation locations via reverse image search, family information, and media preferences. Used the Wayback Machine to recover deleted Reddit content, discovered a coworker connection, traced cached Pastebin links through archived profiles, cracked a password-protected document, and followed the trail to uncover a hidden personal relationship and email address.'
outcome: 'Mapped the complete social graph — identified Thomas birth date (12-20-1990), his fiancee Francesca (@FHodgelink), their vacation to Koblenz Germany, her mother birthday (December 25th), their cat Gotank, her favourite show (90 Day Fiancee), his coworker minik hans in Nuuk Greenland, a cached Pastebin paste (ks{ww4ju}), a protected document password (ks{1qaz2wsx}), his mistress Emilia Moller, and his email address straussmanthom@mail.com.'
draft: false
---
